...
//     use safe_drive::msg::common_interfaces::sensor_msgs::msg::PointCloud2;
...
//     let safe_drive_msg_cloud: PointCloud2 = internal_cloud.into();
//     let convert_back_internal: PointCloud2Msg = safe_drive_msg_cloud.into();
